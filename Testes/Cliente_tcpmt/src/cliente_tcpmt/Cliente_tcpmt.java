/*
 * http://www.guj.com.br/java/202226-multithread-sockets-
 */
package cliente_tcpmt;

import java.net.*;
import java.io.*;

public class Cliente_tcpmt extends Thread {
    ...
    public Cliente_tcpmt(String server, int porta) {
        try {
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 0; i < numeroDeClientes; i++) {
                ...
                new Cliente_tcpmt(server, porta).start();
